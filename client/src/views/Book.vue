    ...
    <van-pull-refresh v-model="isRefreshing" @refresh="onRefresh">
      <div class="content">
        ...
        <section class="text-section">
          <van-swipe-cell v-for="(detail, index) in chapterDetails" :key="index"
            ...
            <!-- 右侧删除按钮 -->
            <template #right>
              <van-button square text="删除" type="danger" class="delete-button" :loading="deletingIds.has(detail.id)"
